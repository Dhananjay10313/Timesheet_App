...
app = Flask(__name__)
app.config["MONGO_URI"] = "mongodb+srv://commonuser:commonuser123@cluster0.czzze.mongodb.net/Logs?retryWrites=true&w=majority&appName=Cluster0&tlsAllowInvalidCertificates=true"
mongo = PyMongo(app)
...
def push_logs_to_mongodb():
    ...
    with app.app_context():
        try:
            ...
            if logs_to_push:
                result = mongo.db.dhananjay.insert_many(logs_to_push)
